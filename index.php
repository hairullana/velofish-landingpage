...
<head>
  <meta charset="utf-8">
  <title>VeloFish by Fisheries Cyber Play</title>
...
<section class="fixed-top navigation">
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-light">
      <a class="navbar-brand" href="index.html"><img src="images/logo.png" height="32px" alt="velofish"></a>
      ...
      <div class="collapse navbar-collapse text-center" id="navbar">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link page-scroll" href="#footer">Contact Us</a>
          </li>
        </ul>
      </div>
    </nav>
...
<!-- hero area -->
<section class="hero-section hero" data-background="" style="background-image: url(images/hero-area/banner-bg.png);" id="header">
  <div class="container">
    <div class="row">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <p class="mb-100">Experience the real environment of the best MMO-survival games with its awesome features that make YOU get addicted.</p>
      </div>
      <!-- feature item -->
      <div class="col-md-6 mb-80">
        <div class="d-flex feature-item">
          <div>
            <i class="bi bi-tsunami feature-icon mr-4"></i>
          </div>
          <div>
            <h4>Solo Survival</h4>
            <p>Learn what it is like to survive in a devastated sea as a fish.</p>
          </div>
        </div>
      </div>
      <!-- feature item -->
      <div class="col-md-6 mb-80">
        <div class="d-flex feature-item">
          <div>
            <i class="bi bi-stoplights feature-icon mr-4"></i>
          </div>
          <div>
            <h4>Online Race</h4>
            <p>Compete with other players in a real-time situation.</p>
          </div>
        </div>
      </div>
      <!-- feature item -->
      <div class="col-md-6 mb-80">
        <div class="d-flex feature-item">
          <div>
            <i class="bi bi-gear feature-icon mr-4"></i>
          </div>
          <div>
            <h4>Customizable Fish</h4>
            <p>Tuna with a shark fin? Shark with tentacles? Modify it all you want.</p>
          </div>
        </div>
      </div>
      <!-- feature item -->
      <div class="col-md-6 mb-80">
        <div class="d-flex feature-item">
          <div>
            <i class="bi bi-graph-up-arrow feature-icon mr-4"></i>
          </div>
          <div>
            <h4>Upgradeable Fish</h4>
            <p>Do you want your fish to run like a Lambo? Say no more!</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="section-lg seo">
  <div class="container">
    <div class="row">
      <div class="col-md-5">
        <div class="seo-image">
          <img class="img-fluid" src="images/animasi-ikan-1.png" alt="form-img">
        </div>
      </div>
      <div class="col-md-7">
        <h2 class="section-title">Select and Upgrade Your Fish!</h2>
        <p>The fish can be modified in appearance and upgraded in performance according to what you want to feel the journey and fun while playing.</p>
      </div>
    </div>
  </div>
  <!-- background image -->
...
<!-- service -->
<section class="section-lg service" id="donate">
  <div class="container">
    <div class="row justify-content-between">
      <div class="col-md-7 order-2 order-md-1">
        <h2 class="section-title">Marine Ecosystem Rescue Donation</h2>
        <p class="mb-4">Proceeds from in-game transactions will be donated to save the underwater ecosystem. So that you could have a "social impact" in helping the marine ecosystems save by playing Velofish.</p>
      </div>
      <div class="col-md-5 order-1 order-md-2">
        <img class="img-fluid layer-3" src="images/animasi-ikan-2.png" alt="service">
      </div>
    </div>
  </div>
  <!-- background image -->
...
<!-- pricing -->
<section class="section-lg pb-0 pricing" id="download">
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <div class="row justify-content-center">
          <div class="col-12 mb-5 mb-lg-0">
            <div class="rounded text-center pricing-table table-2">
              ...
              <a href="https://drive.google.com/file/d/1yGbO08sYIu0XCJU8Mu3mI0B0ulmTaX5q/view?usp=sharing" class="btn btn-primary ml-lg-3 primary-shadow font-weight-bold">Download</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <nav class="col-lg-8 align-self-center mb-5">
        <ul class="list-inline text-lg-right text-center footer-menu">
          <li class="list-inline-item active"><a class="page-scroll" href="#header">Home</a></li>
          <li class="list-inline-item"><a class="page-scroll" href="#feature">Feature</a></li>
          <li class="list-inline-item"><a class="page-scroll" href="#donate">Donate</a></li>
          <li class="list-inline-item"><a class="page-scroll" href="#download">Download</a></li>
        </ul>
      </nav>
      <!-- footer social icon -->
